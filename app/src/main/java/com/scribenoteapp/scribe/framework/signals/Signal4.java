...
public class Signal4<T, T1, T2, T3> {
    ...
    class SignalItem {
        ...
        private Function4<T, T1, T2, T3, Void> function;

        SignalItem(Function4<T, T1, T2, T3, Void> function) {
            this.isActive = true;
        ...
        void run(T t, T1 t1, T2 t2, T3 t3) {
            this.function.function(t, t1, t2, t3);
        }
    }
}
